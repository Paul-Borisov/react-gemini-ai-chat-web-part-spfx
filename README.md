...
- Base URL for Gemini AI: https://generativelanguage.googleapis.com/v1beta (v1beta prodides the optional Function Calling feature of Gemini Pro while v1 does not have it yet)
